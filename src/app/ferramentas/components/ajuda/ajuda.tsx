      ...
      <Box className="ajuda-container">
        ...
        <Box className="ajuda-lista">
          ...
          <Typography variant="body2" gutterBottom sx={{ mb: 2 }}>
            As telas de listagem do sistema seguem um padrão de uso para
            facilitar a navegação e a interação. Abaixo estão os elementos mais
            comuns nas telas (exceto &quot;NOTIFICAÇÕES&quot;):
          </Typography>
